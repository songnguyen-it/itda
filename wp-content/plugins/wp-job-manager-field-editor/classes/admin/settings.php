...
class WP_Job_Manager_Field_Editor_Settings extends WP_Job_Manager_Field_Editor_Settings_Handlers {
	...
	function init_settings() {
			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						array(
							'name'       => 'jmfe_disable_using_chosen',
							'std'        => '0',
							'label'      => __( 'Select2', 'wp-job-manager-field-editor' ),
							'cb_label'   => __( 'Yes, use Select2 instead of Chosen for multiselect, select, term-select, and term-multiselect fields', 'wp-job-manager-field-editor' ),
							'desc'       => __( 'Enable this setting to use Select2 instead of the legacy Chosen.js framework for select field types.  PLEASE NOTE: If you enable this Dynamic Child Taxonomies and Max Selected will 100% NOT work.  Conditional Logic may also have some issues with any Select2 fields (should still work for others). The next version, 1.10.0 will move from using Chosen to Select2.', 'wp-job-manager-field-editor' ),
							'type'       => 'checkbox',
							'attributes' => array(),
							'class'      => 'jmfe-settings-separator',
						),
				...
				'admin' => array(
					...
					array(
						...
						array(
							...
							'type'     => 'checkbox',
							'label'    => __( 'Chosen.JS', 'wp-job-manager-field-editor' ),
							'desc'     => __( 'Chosen.JS is the framework used by WP Job Manager that makes long, unwieldy select/multiselect boxes much more user-friendly.', 'wp-job-manager-field-editor' ),
							'std'      => '0',
							'cb_label' => __( 'Enable', 'wp-job-manager-field-editor' ),
						),
						array(
		...
		if( ! $this->fields()->wpjma_active() ) {
			...
			unset( $this->settings['recaptcha'][1][5] );
		}
