...
class WP_Job_Manager_Field_Editor_Assets {
	...
	function __construct() {
		...
		// TODO: remove this after moving to Select2
	...
	function submit_form_css() {
		if( ! WP_Job_Manager_Field_Editor::disable_chosen() ){
	...
	public static function register_select2_assets() {
		if( ! wp_script_is( 'select2', 'registered' ) ){
			wp_register_script( 'select2', WPJM_FIELD_EDITOR_PLUGIN_URL . '/assets/js/select2/select2.full.min.js', array( 'jquery' ), '4.0.5' );
		}
		if( ! wp_style_is( 'select2', 'registered' ) ){
			wp_register_style( 'select2', WPJM_FIELD_EDITOR_PLUGIN_URL . '/assets/css/select2/select2.min.css', array(), '4.0.5' );
		}
	}
	...
	public function register_chosen(){
		...
		if ( ! wp_script_is( 'chosen', 'registered' ) && defined( 'JOB_MANAGER_PLUGIN_URL' ) ) {
			wp_register_script( 'chosen', JOB_MANAGER_PLUGIN_URL . '/assets/js/jquery-chosen/chosen.jquery.min.js', array( 'jquery' ), '1.1.0', false );
		}
		...
		if( WP_Job_Manager_Field_Editor::has_wpjm_shortcode() && ! WP_Job_Manager_Field_Editor::disable_chosen() ){
