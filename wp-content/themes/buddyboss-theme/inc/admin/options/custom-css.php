...
if ( !function_exists( 'boss_generate_option_lifterLMS_css' ) ) {
    function boss_generate_option_lifterLMS_css() {
		...
		<?php ob_start(); ?>
            ...
            .llms-pointer.llms-inner .lifter-topic-sidebar-wrapper .lifter-sidebar-widgets ul li.widget a,
            ...
            .llms-pointer.llms-inner .lifter-topic-sidebar-wrapper .lifter-sidebar-widgets ul li.widget a:hover,
